 ...
 */
final class Version20220621192526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD plain_password VARCHAR(180) NOT NULL, ADD type VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP plain_password, DROP type');
    }
}
